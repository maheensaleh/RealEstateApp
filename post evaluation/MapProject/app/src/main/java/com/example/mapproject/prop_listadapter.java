...
public class prop_listadapter  extends ArrayAdapter<property> {
    ...
    public prop_listadapter(@NonNull FragmentActivity context, int resource, ArrayList<property>objects) {
...
//            holder2 = new  ViewHolder();
            holder.img = (ImageView) convertView.findViewById(R.id.Apic1);
            holder.addr = (TextView) convertView.findViewById(R.id.Aaddress);
