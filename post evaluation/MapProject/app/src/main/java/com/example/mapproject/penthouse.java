...
public class penthouse extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            TextView property=findViewById(R.id.paddress_submit);
        ...
        mRatingBar = (RatingBar) findViewById(R.id.pratingBar);
        mRatingScale = (TextView) findViewById(R.id.ptvRatingScale);


        rooms_qty = (TextView) findViewById(R.id.prooms_qty);

        img1 = (ImageView) findViewById(R.id.pimg1);
        img2 = (ImageView) findViewById(R.id.pimg2);
        img3 = (ImageView) findViewById(R.id.pimg3);
        img4 = (ImageView) findViewById(R.id.pimg4);
        bitmap_1 =null;
        flat_db=new flat_for_sell_DB(this);

        //to set initial scroll to top
        final ScrollView scrollView = (ScrollView) findViewById(R.id.pscroll_flat_form);
        scrollView.smoothScrollTo(0, 0);

        // area sizes
        Integer[] users = {800, 1300, 1600, 2200};
        spin = (Spinner) findViewById(R.id.pflat_area);
    ...
    public void addlocation(View view) {
        Intent sell = new Intent(penthouse.this, seller.class);
        sell.putExtra("type","penthouse");
    ...
    public void preview_ad_penthouse(View view) {


        //checkboxes values
        sale = (CheckBox) findViewById(R.id.pfor_sale);
        rent = (CheckBox) findViewById(R.id.pfor_rent);
        balcony = (CheckBox) findViewById(R.id.pbalcony);
        elevator = (CheckBox) findViewById(R.id.pelevator);
        ...
        //views
        address = (EditText) findViewById(R.id.paddress_submit);
        rooms_qty = (TextView) findViewById(R.id.prooms_qty);
        ...
        System.out.println("PPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEE");
        ...
        flat_db.insertdata(address.getText().toString(),rent_sale,
                elevator_status,balcony_status,"Not Applicable",rooms_qty.getText().toString(),img1_bytes,img2_bytes,img3_bytes,img4_bytes,
                spin.getSelectedItem().toString(),rating_comment,rating_value.toString(),price.getText().toString(),"Penthouse","russel"
                );
        //Sstart another activity
        Intent to_flat_preview = new Intent(penthouse.this, MainActivity.class);
