...
public class flat_for_sell_DB extends SQLiteOpenHelper {


    public static final String DATABASE_NAME="flats_for_sell.db";
    public static final String TABLE_NAME="flats_for_sell_table";
    ...
    public flat_for_sell_DB(@Nullable Context context) {
