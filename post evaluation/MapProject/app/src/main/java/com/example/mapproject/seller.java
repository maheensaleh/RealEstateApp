...
public class seller extends FragmentActivity implements OnMapReadyCallback {
...
//auto complete location search view
        ...
        autoCompleteTextView.setAdapter(new placeautosuggestadapter(seller.this,android.R.layout.simple_list_item_1));
